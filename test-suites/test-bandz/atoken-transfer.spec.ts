...
makeSuite('AToken: Transfer', (testEnv: TestEnv) => {
  ...
  it('User 0 deposits 1000 FLEXUSD, transfers to user 1', async () => {
    ...
    expect(name).to.be.equal('Bandz interest bearing FLEXUSD');
  ...
  it('User 0 deposits 1 WBCH and user 1 tries to borrow the WBCH with the received FLEXUSD as collateral', async () => {
