...
import { strategyWETH } from '../../markets/bandz/reservesConfigs';
...
makeSuite('LendingPoolConfigurator', (testEnv: TestEnv) => {
  ...
  it('Check the onlyBandzAdmin on deactivateReserve ', async () => {
  ...
  it('Check the onlyBandzAdmin on activateReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyBandzAdmin on freezeReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyBandzAdmin on unfreezeReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyBandzAdmin on disableBorrowingOnReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyBandzAdmin on enableBorrowingOnReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyBandzAdmin on configureReserveAsCollateral ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
      configurator
  ...
  it('Check the onlyBandzAdmin on disableReserveStableRate', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyBandzAdmin on enableReserveStableRate', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
